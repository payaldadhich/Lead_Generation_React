          ...
          item.subAnswer.map((sitem,i)=>
            sitem.subAnswer.map((ssitem,i)=>{
              if(ssitem.mainAnswer == 'Queen Lifestyle Program -- the tools needed for a bikini body'){
                $("#link").html("https://www.okonfit.com/p/queen-lifestyle-sign-up")
                document.getElementById("link").href="https://www.okonfit.com/p/queen-lifestyle-sign-up";
                ...
                $("#link").html("https://www.okonfit.com/p/about-VIP-Transformation-program")
                document.getElementById("link").href="https://www.okonfit.com/p/about-VIP-Transformation-program";
                ...
                $("#link").html("https://www.okonfit.com/store/2HN84xSg")
                document.getElementById("link").href="https://www.okonfit.com/store/2HN84xSg";
                ...
                <div className={"sales-box-text "+this.state.activeStep} id="step6">
                  <div className="result-from-design">
                    <div className="row">
                      ...
                      <a id="link">We required redirect link for this section</a>
                    </div>
                  </div>
                </div>
              </div>
